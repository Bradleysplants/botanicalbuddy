...
INSTALLED_APPS = [
    ...
    'django_filters',
    'pgvector.django',  # If you're using pgvector
]
...
ROOT_URLCONF = 'botanicalbuddy.urls'  # Replace with your project's name
...
WSGI_APPLICATION = 'botanicalbuddy.wsgi.application'  # Replace with your project's name
